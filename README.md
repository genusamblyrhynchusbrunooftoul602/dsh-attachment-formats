...
> web plugin that makes the composer accept many more attachment formats, Codex-style:
> PDF text-layer extraction (pymupdf4llm high-fidelity engine / pdfjs fallback), Office
> (docx/xlsx/pptx) text extraction, long-document spill + index cards, scanned-PDF OCR
> (tesseract.js), and browser-decodable images → PNG. Pure plugin, zero core-package
> changes. Install: `dsh plugin --profile web add github:linkingoscar/dsh-attachment-formats`.
...
dsh plugin --profile web add link:"D:\植物大战僵尸\deepsekkharness\projects\dsh-attachment-formats"
```
